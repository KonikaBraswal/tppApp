...
// import { useNavigation } from '@react-navigation/native';
// import { Searchbar, Dialog, Portal, Button } from 'react-native-paper';
// import AsyncStorage from '@react-native-async-storage/async-storage';
// import ApiFactory from '../../../ApiFactory_VRP/ApiFactory';
// import { RFValue } from 'react-native-responsive-fontsize';
// import sandboxConfig from '../../../configs_VRP/Sandbox.json';
...
//     try {
//       const customerDetails = await sandboxApiClient.exchangeAccessToken(inputValue, consentData);
//       navigation.navigate('Customer Details', { customerDetails });
//     } catch (error) {
//       console.error('Error:', error);
//       setError('Failed to retrieve access token.');
//     } finally {
...
//   const handleConfirmButtonClick = async () => {
//     try {
//       const permissions = {}; // Your permission data here
//       setLoading(true);
//       setError(null);
//       const accessTokenParams = { scope: 'payments', headers: { 'Content-Type': 'application/x-www-form-urlencoded' }, body: permissions, consentUrl: sandboxConfig.paymentRequestEndPoint };
...
//           <TouchableOpacity key={index} onPress={() => handleConfirmButtonClick(bank.id)}>
//             <View style={styles.bankItemContainer}>
//               <Image source={bank.icon} style={{ height: 50, width: 50, resizeMode: 'contain' }} />
...
//           <Dialog.Title>Redirect Input</Dialog.Title>
//           <Dialog.Content>
//             <TextInput label="Paste URL from the browser" value={inputValue} onChangeText={setInputValue} />
//           </Dialog.Content>
//           <Dialog.Actions>
//             <Button onPress={hideInputDialog}>Cancel</Button>
//             <Button onPress={handleSubmit}>Submit</Button>
...
// // Define styles
// const styles = StyleSheet.create({
//   bankItemContainer: { flexDirection: 'row', alignItems: 'center', padding: 13, borderBottomWidth: 1, borderBottomColor: '#ddd' },
//   name: { alignItems: 'center', width: '100%', fontWeight: 'bold' },
// });
  ...
  const handleSubmit = async () => {
    try {
      ...
      const details = {
        ...
        consentpayload: JSON.stringify(consentData.Data),
