...
export const initDatabase = () => {
  db.transaction(tx => {
    tx.executeSql(
      ...
      [],
      (tx, results) => {
        console.log('userconsent_sandbox table created successfully',results);
      },
      error => {
...
// export const processConsentId = () => {
//     console.log('Consent ID:', globalConsentId);
//   };
