...
import { View, StyleSheet, Text, FlatList, Image, TouchableOpacity, KeyboardAvoidingView, Platform, Keyboard, Dimensions } from "react-native";
  ...
  >
      <View style={{ flex: 1 }}>
        ...
        <View style={styles.container}>
          <View style={{backgroundColor:'#c8e1cc',width:'100%',height:'500',borderRadius:20,padding:10,margin:10}}>
          ...
          <FlatList
            ...
            contentContainerStyle={{ ...styles.flatListContainer, backgroundColor: '#c8e1cc',justifyContent:'space-around' }}
          />
          </View>
          <View style={styles.addBankContainer}>
            ...
            <FAB
              ...
              onPress={AddBank}
            />
            <Text style={{ fontWeight: 'bold', color: "black", marginBottom:40, marginTop: 10 }}>Add Bank Account</Text>
          </View>
          <View style={styles.lastrowBackground}>
            <View style={styles.lastrow}>
              <TouchableOpacity>
                <Surface elevation={1} category="medium" style={styles.cardsurface}>
                  <Text style={{ fontSize: 16, color: "black", fontWeight: 'bold', marginTop: 10 }}>Payments</Text>
                  <Image source={Payments.image} style={styles.images} />
                </Surface>
              </TouchableOpacity>
              <TouchableOpacity>
                <Surface elevation={1} category="medium" style={styles.cardsurface}>
                  <Text style={{ fontSize: 16, color: "black", fontWeight: 'bold', marginTop: 10 }}>VRP</Text>
