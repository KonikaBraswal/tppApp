...
const ConsentInfo = ({route}) => {
  const {transactionDetails, consentpayload} = route.params;
            ...
            <DataTable>
              <View style={{backgroundColor: '#D6CFC7'}}>
                ...
                <DataTable.Header>
                  <DataTable.Title
                    style={{maxWidth: 200}}
                    textStyle={{color: 'black', fontSize: RFValue(15)}}
                    numberOfLines={2}>
                    Reference
                  </DataTable.Title>
                  <DataTable.Title
                    numeric
                    textStyle={{color: 'black', fontSize: RFValue(15)}}>
                    {payload.Initiation.RemittanceInformation.Reference}
                  </DataTable.Title>
                </DataTable.Header>
                <DataTable.Header>
                  <DataTable.Title
                  ...
                  <DataTable.Title
                    numeric
                    textStyle={{color: 'black', fontSize: RFValue(15)}}>
                    {payload.ControlParameters.PeriodicLimits[0].PeriodType}
                  </DataTable.Title>
                </DataTable.Header>
                <DataTable.Header>
                  <DataTable.Title
                  ...
                  <DataTable.Title
                    numeric
                    textStyle={{color: 'black', fontSize: RFValue(15)}}>
                    £{payload.ControlParameters.PeriodicLimits[0].Amount}
                  </DataTable.Title>
                </DataTable.Header>
                <DataTable.Header>
                  <DataTable.Title
                  ...
                  <DataTable.Title
                    numeric
                    textStyle={{color: 'black', fontSize: RFValue(15)}}>
                    £{payload.ControlParameters.MaximumIndividualAmount.Amount}
                  </DataTable.Title>
                </DataTable.Header>
                <DataTable.Header>
                  <DataTable.Title
                  ...
                  <DataTable.Title
                    ...
                    textStyle={{color: 'black', fontSize: RFValue(15)}}>
                    {new Date(
                      payload.ControlParameters.ValidToDateTime,
                    ).toLocaleDateString()}
                  </DataTable.Title>
                </DataTable.Header>
              </View>
            ...
            <DataTable>
              ...
              <DataTable.Header>
                ...
                <DataTable.Title
                  numeric
                  textStyle={{color: 'black', fontSize: RFValue(15)}}>
                  {payload.Initiation.CreditorAccount.Name}
                </DataTable.Title>
              </DataTable.Header>
              ...
              <DataTable.Header>
                ...
                <DataTable.Title
                  numeric
                  textStyle={{color: 'black', fontSize: RFValue(15)}}>
                  {payload.Initiation.CreditorAccount.Identification.substring(
                    0,
                    8,
                  )}
                </DataTable.Title>
              ...
              <DataTable>
                ...
                <DataTable.Header>
                  ...
                  <DataTable.Title
                    numeric
                    textStyle={{color: 'black', fontSize: RFValue(15)}}>
                    {transactions.DebtorAccount.Name}
                  </DataTable.Title>
                </DataTable.Header>
                ...
                <DataTable.Header>
                  ...
                  <DataTable.Title
                    numeric
                    textStyle={{color: 'black', fontSize: RFValue(15)}}>
                    {transactions.DebtorAccount.Identification.substring(0, 8)}
                  </DataTable.Title>
                </DataTable.Header>
                <DataTable.Header>
                  <DataTable.Title
                  ...
                  <DataTable.Title
                    numeric
                    textStyle={{color: 'black', fontSize: RFValue(15)}}>
                    {transactions.DebtorAccount.Identification.substring(8)}
                  </DataTable.Title>
                </DataTable.Header>
              </DataTable>
            )}
