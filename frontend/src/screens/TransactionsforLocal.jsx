...
import readbalanceData from '../../DatabaseFactory/MockData/balances.json';
import readaccountData from '../../DatabaseFactory/MockData/accounts.json';
import readtransactionData  from '../../DatabaseFactory/MockData/transactions.json' ;
const mode = 'sandbox';
const way = 'web';
