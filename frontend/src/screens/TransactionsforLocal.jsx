...
import readbalanceData from '../../ApiFactory/MockData/balances.json';
import readaccountData from '../../ApiFactory/MockData/accounts.json';
import readtransactionData  from '../../ApiFactory/MockData/transactions.json' ;
const mode = 'sandbox';
const way = 'web';
