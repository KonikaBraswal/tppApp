    ...
    if (mode == 'sandbox') {
      try {
        const permissions = [
         ...
         //const consentData = await sandboxApiClient.retrieveAccessToken("payments"); //to make a payments type call
         const consentData = await sandboxApiClient.retrieveAccessToken("accounts");//to make accounts call
