...
const TransactionCard = ({transaction}) => {
  ...
  {transaction.Amount && transaction.Amount.Currency ? transaction.Amount.Currency : 'N/A'}{' '}
  {transaction.Amount && transaction.Amount.Amount ? transaction.Amount.Amount : '0.00'}
</Text>
